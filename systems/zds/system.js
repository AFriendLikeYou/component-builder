...
window.SYSTEM = {
  ...
  atoms: [
    ...
    { id: 'btn-pill', name: 'Knopf mit Text', match: '.btn-pill', use: 'Eine Aktion mit Wort, optional mit Icon davor. Im ZDS eckig mit 4 px Radius.', variants: { lg: 'Groß · 40', solid: 'Gefüllt' }, sample: '<button class="btn-pill t-14 w-500 {v}">{icon:plus:16}Hinzufügen</button>' },
