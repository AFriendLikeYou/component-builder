// Das Regelwerk als Daten – die einzige Quelle für Regeln und Werte.
...
window.SYSTEM = {
  ...
  unit: 8,          // Raster: Kartengröße, Position und Größe jeder Fläche sind Vielfache davon
  ...
  // `code` in Backticks wird in der Ansicht als Code gesetzt. {unit}, {inset}, {limits.sizes} … sind Platzhalter für die Werte oben.
  rules: [
    {
      id: 'R1', title: 'Raster {unit} px', checks: ['grid', 'card'],
    ...
    {
      id: 'R2', title: 'Inset {inset} px', checks: ['inset'],
    ...
    {
      id: 'R3', title: 'Schrift', checks: ['family', 'families', 'sizes', 'weights', 'scale', 'leading'],
    ...
    {
      id: 'R4', title: 'Radien', checks: ['radius'],
